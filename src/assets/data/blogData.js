...
const blogData = [
  {
    ...
    author: "Pratik Kumar Singh",
    date: "12 Dec, 2021",
    time: "9pm",
    imgUrl: img01,
    description: `"Driving a car is a responsibility that requires skill, knowledge, and patience. Here are some tips on the best way to drive cars:

    Follow traffic rules: Obey traffic signals, signs, and speed limits. Remember that traffic laws are in place for your safety and the safety of others on the road.
    
    Avoid distractions: Distracted driving is a leading cause of accidents. Avoid using your phone, eating, or doing anything that takes your attention away from the road.
    
    Maintain your vehicle: Regular maintenance ensures that your car is in good condition and can perform at its best. Check the tire pressure, brakes, and fluid levels before every trip.
    
    Adjust your seat and mirrors: Before driving, adjust your seat and mirrors to ensure that you have a clear view of the road and your surroundings.
    
    Stay focused: Stay alert and aware of your surroundings at all times. Anticipate potential hazards and be prepared to react quickly.
    
    Use turn signals: Signal your intentions to other drivers by using your turn signals. This helps prevent accidents and promotes safe driving.
    
    Keep a safe following distance: Maintain a safe distance from the vehicle in front of you. This gives you enough time to react if they suddenly stop or slow down.
    
    Remember, safe driving is a responsibility that we all share. By following these tips, we can promote safe driving habits and help prevent accidents on the road."`,
    quote: `
    "Driving isn't just about going from A to B. It's about being aware and staying alive. That's what makes a good driver." - Jeremy Clarkson
    `,
  },
